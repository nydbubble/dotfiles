...
local suspend_command = function()
  exit_screen_hide()
  awful.spawn("i3lock-fancy-rapid 10 3")
...
local poweroff_icon = wibox.widget.imagebox(beautiful.poweroff)
...
local reboot_icon = wibox.widget.imagebox(beautiful.reboot)
...
local suspend_icon = wibox.widget.imagebox(beautiful.suspend)
...
local exit_icon = wibox.widget.imagebox(beautiful.exit)
...
local lock_icon = wibox.widget.imagebox(beautiful.lock)
